...
class LicenseDialog(CustomDialog):
    def __init__(self, master, zx_editor):
        super().__init__(master, zx_editor, title="License")

    def create_body(self, master):
        lbl = ttk.Label(master, text=self.zx_editor.PROGRAM_TITLE, justify=CENTER)
        ...
        lbl = ttk.Button(master, text="Open LICENSE.md", style="info link", command=lambda: self.open_url(self.zx_editor.PROGRAM_LICENSE_URL))
